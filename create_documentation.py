...
pdf.add_section("Technical Architecture", 
"""Frontend:
...
# Running Locally
pdf.add_section("Running Locally", 
"""Prerequisites:
...
# Deploying on Render
pdf.add_section("Deploying on Render", 
...
# Project Structure
pdf.add_section("Project Structure", 
...
# Future Enhancements
pdf.add_section("Future Enhancements", 
